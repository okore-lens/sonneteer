...
const PostCard = ({ post }: PostCardProps) => {
	const { title, thumbnail_url, created_at } = post || {};
	return (
		<section className="relative w-full h-80 md:h-64 rounded-2xl overflow-hidden lg:hover:scale-[1.005] group transition-scale duration-1000">
			<Image
